...
const SocialFlipNode = ({
    ...
    return (
        <Wrapper
            {...wrapperProps}
            className={cn("relative h-8 w-8 sm:h-10 sm:w-10 cursor-pointer", itemClassName)}
...
export  function SocialFlipButton({
    ...
    return (
      <div className={cn("flex items-center justify-center gap-4 p-0", className)}>
        <div
          className="group relative flex flex-row flex-wrap items-center justify-center gap-1 sm:gap-2 rounded-2xl glass-border bg-white p-2 sm:p-3 shadow-sm dark:bg-black"
